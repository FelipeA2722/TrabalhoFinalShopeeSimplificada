...
// Similar ao buscarPorId
    ...
    @Override public List<Usuario> buscarTodos() throws SQLException { return
            null; }
    @Override public void atualizar(Usuario entidade) throws SQLException {}
